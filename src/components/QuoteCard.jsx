    ...
    <div className="glass rounded-xl p-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <select
          ...
          className="w-full sm:w-auto rounded-lg border border-cyan-400/20 bg-slate-800/40 backdrop-blur pl-4 pr-10 py-2.5 text-sm font-medium text-white shadow-sm focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-400/50"
        >
